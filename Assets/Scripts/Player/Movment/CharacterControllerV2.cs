...
public class CharacterControllerV2 : MonoBehaviour
{
    ...
    [SerializeField, HideInNormalInspector]PlayerCustomMovment _playerCustomMovment;
    ...
    public Vector3 CurrentInputDir
    {
        get
        {
            return MultiplyByPlane(worldInputDir, transform.up);
        }
    }
    ...
    void PlayerHorizontalMovment(Vector2 input)
    {
        ...
        Vector3 outputHorizontal = MultiplyByPlane(currentVel2d, _groundDetect.GroundNormal);
    ...
    /// </summary>
    Vector3 MultiplyByPlane(Vector2 plane, Vector3 planeNormal)
    {
